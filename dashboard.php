...
<body>
  ...
  <div class="row">
    <div class="sidebar" style="background-color: #F1F1F1; width: 15%; float: left; padding: 10px; height: 700px;">
    	 ...
    	 <?php
            ...
            echo '
             <div class="list-group">
                ...
                <a href="dataproduk.php" class="list-group-item list-group-item-action"><i class="fas fa-box"></i>&nbsp;&nbsp;Produk</a>
                ...
                <a href="dataadmin.php" class="list-group-item list-group-item-action"><i class="fas fa-user-tie"></i>&nbsp;&nbsp;Data Admin</a>
                <a href="datamember.php" class="list-group-item list-group-item-action"><i class="fas fa-user"></i>&nbsp;&nbsp;Data Member</a>
        ...
        &nbsp;
        <div class="list-group">
            <a href="logout.php" class="list-group-item list-group-item-action"><i class="fas fa-sign-out-alt"></i>&nbsp;&nbsp;Keluar</a>
        </div>
    ...
    <div class="sidebar-right" style="background-color: #D6DDE5; width: 85%; padding: 4px">
        <div class="namebar" style="background-color: #40AB9B; height: 40px; width: 100%;">
            ...
            <a class="btn btn-light dropdown-toggle" type="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="float: right;margin-top: 1px; height: 40px;"><i class="fas fa-user-circle"></i>&nbsp;&nbsp;<?php echo $_SESSION['nama']; ?></a>
