<?php
  ...
  if (isset($_POST['btnpros'])) {
    ...
    $querydelete = "DELETE FROM produk WHERE id_produk=$id_produk";
...
<!-- modal hapus -->
<form method="POST">
<div class="modal fade" id="modalHapusProduk<?php echo $row['id_produk']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <?php
          $id = $row['id_produk'];
          $queryhapus = "SELECT * FROM produk WHERE id_produk=$id";
      ...
      <div class="modal-body">
          <div class="form-group row">
            ...
            Apakah anda yakin ingin menghapus data &nbsp; <strong><?php echo $rowhapus['nama_produk'];?></strong>
          </div>
      </div>
